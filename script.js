...
const translations = {
  es: {
    ...
    heroTitle: `${HERO_WORDMARK} Training Club: tu mejor version comienza aqui`,
  ...
  en: {
    ...
    heroEyebrow: `${WORDMARK} Training Club · Cabo San Lucas`,
    heroTitle: `${HERO_WORDMARK} Training Club: your best version starts here`,
